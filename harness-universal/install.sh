...
for item in check.sh review.sh session-context.sh figma-check.sh harness.config.json review-protocol.md AGENTS.md README.md CODEX_SETUP.md CLAUDE_SETUP.md git-hooks bin adapters ci presets; do
